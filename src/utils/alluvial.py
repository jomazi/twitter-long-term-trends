# source: https://github.com/vinsburg/alluvial_diagram/blob/master/alluvial.py (accessed 24-12-21)
# some layout adjustments (e.g. font, fontsize)
...
class AlluvialTool:
    ...
    def auto_label_veins(self, fontname='DejaVu Sans', **kwargs):
        ...
        for item, vein in self.item_coord_dic.items():
            ...
            plt.text(
                ...
                ha=ha, va='center', fontname=fontname, fontsize=14)

    def label_sides(
            self, labels=None, label_shift=0, disp_width=False, wdisp_sep=7 * ' ', fontname='DejaVu Sans', **kwargs):
        if labels is not None:
            ...
            for side, sign in enumerate((-1, 1)):
                plt.text(
                    ...
                    ha='center', va='center', fontname=fontname, fontsize=14, rotation=90 - 180 * side
                )
